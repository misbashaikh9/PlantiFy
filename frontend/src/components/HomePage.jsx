  ...
  return (
    <div className="homepage-container">
      ...
      <main className="homepage-main">
        ...
        {/* Magazine and Suggestions Boxes Container */}
        <div className="magazine-boxes-container">
          {/* Magazine Box */}
      ...
      <div className="ai-chat-icon" onClick={() => {
        console.log('AI button clicked! Navigating to /ai-care');
        navigate('/ai-care');
      }}>
